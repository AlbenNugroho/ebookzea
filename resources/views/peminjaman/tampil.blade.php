...
@section('judul')
    <h2 class="m-0 font-weight-bold" style="color: #293462;">Daftar Riwayat Peminjaman</h2>
@endsection
...
@section('content')
    ...
    <div class="container">
        ...
        <a href="/cetaklaporan" class="btn mb-3 mx-2" style="background-color: #FEB139; color: white;"><i class="fa-solid fa-print"></i> Cetak</a>
    </div>
