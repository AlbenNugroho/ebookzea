...
@section('judul')
    <h1 class="text-body">Dashboardjjjj</h1>
@endsection
...
@section('content')
    <div class="row mb-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100" style="background-color: #FEF9A7">
                <div class="card-body">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100" style="background-color: #FAC213">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm text-white font-weight-bold text-uppercase mb-1">Kategori</div>
                            <div class="text-sm text-white h5 mb-0 font-weight-bold">{{ $kategori }}</div>
                            <div class="button mt-2"><a href="/kategori" class="text-white">Lihat</a></div>
                        </div>
                        <div class="col-auto">
                            <i class="fa-solid fa-bookmark fa-3x text-white"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100" style="background-color: #F77E21">  
                <div class="card-body">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100" style="background-color: #D61C4E">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <!-- Table-->
    <h1 class="text-body"> Riwayat Peminjaman</h1>
